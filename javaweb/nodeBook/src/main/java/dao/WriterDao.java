...
public class WriterDao {
     ...
     *@Date 2022/5/21 8:54
     */
    public ArrayList<Integer> getBooks(Integer writerId) throws Exception {

        Connection con = dataSource.getConnection();
        Statement stmt = con.createStatement();
        String sql = "select id from book where writer_id = "+ writerId;
    ...
    public User login(String username) throws Exception {
        ...
        String sql = "select id,password from writer where username ='"+username+"'";
    ...
    public List register(String username, String password, String nickname) throws Exception {
        ...
        try {
            ...
            callableStatement = con.prepareCall("{CALL do_add_writer(?,?,?,?)}");
            ...
            Statement stmt = con.createStatement();
            String sql = "UPDATE writer SET nickname = '"+nickname+"' WHERE id = "+userId;
