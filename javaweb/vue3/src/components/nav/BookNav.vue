...
/* 多表单 */	
import { ref,reactive,toRaw,onMounted,require} from 'vue'
...
onMounted(()=>{
	...
	.then(res=>{
		...
		/* 此处与其他调用资源不同
		   因为调用getimg方法时require的会导致入参url变成undefined */
		imgNav.Detail = require('@/assets/ImgData/'+BookNav.Detail.imgUrl);
...
<template>
	<div id="book">
		<el-row :gutter="10">			  
		    <el-col :span="6" >
				<el-image style="width: 160px; height: 200px; " :src="imgNav.Detail" />
			</el-col>
